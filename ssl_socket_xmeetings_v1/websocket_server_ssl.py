...
def get_ip_address():
    ...
    log("info", "local address:"+localIP)
    return localIP
...
#####    added by Amandashan end
    ...
    def send_INVITE_response_confroom(self,sock, msg_info):
        sdp_content ="v=0\r\no=root 176267762 176267762 IN IP4 %s\r\ns=python\r\nc=IN IP4 %s\r\nt=0 0\r\nm=audio 10000 RTP/SAVPF 9 0 8 3\r\na=rtpmap:9 G722/8000\r\na=rtpmap:0 PCMU/8000\r\na=rtpmap:8 PCMA/8000\r\na=rtpmap:3 GSM/8000\r\na=maxptime:150\r\na=ice-ufrag:66bc032d5162cf772b4a77b004e291e2\r\na=ice-pwd:6a913b70289bde762512c5e34495e139\r\na=candidate:Hacacac06 1 UDP 2130706431 %s 10000 typ host\r\na=candidate:Hacacac06 2 UDP 2130706430 %s 55913 typ host\r\na=connection:new\r\na=setup:active\r\na=fingerprint:sha-256 67:04:9D:03:6D:64:FA:31:2C:83:B1:4F:90:8F:E4:33:5D:F1:A4:F8:6C:59:8D:38:B7:DA:94:7F:92:73:52:BE\r\na=sendrecv\r\n"%(msg_info.local_ip_number,msg_info.local_ip_number,msg_info.local_ip_number,msg_info.local_ip_number)
        ...
        ok_response +="Record-Route: <sip:127.0.0.1:6060;transport=udp;lr;ovid=asdfghjkl>\r\n"
...
########################### 
    def parse(self,text):
        ...
        "line%s:Say GoodBye to the girl"%sys._getframe().f_lineno
        log("info", "line%s:text=%s"%(sys._getframe().f_lineno,str(text)))
        try:
            lines = text.split('\r\n')
...
#         sdp_content += "\r\na=maxptime:150\r\na=sendrecv\r\nm=video 29116 RTP/AVP 31 34 98 99 104 100\r\na=rtpmap:31 H261/90000\r\na=rtpmap:34 H263/90000\r\na=rtpmap:98 h263-1998/90000\r\na=rtpmap:99 H264/90000\r\na=rtpmap:104 MP4V-ES/90000\r\na=rtpmap:100 VP8/90000\r\na=rtcp-fb:* ccm fir\r\na=sendrecv"
        ...
        if msg_info.hastotag == True:
            if msg_info.meeting_pw == "NONE" or msg_info.meeting_pw == "":
                invite_request += "To: <sip:%s@%s:%d>;tag=%s\r\n"%(msg_info.meeting_id_to_user, msg_info.local_ip_number, int(msg_info.local_port_number), self.av_invite_totag)
            else:
...
#         print "data:"+str(data)
#         print "sipMethond:"+str(sipMethod)
        if data == "":
            return "NONE"
...
#        sipServer_commonlib.__init__(self,self.service_msg)
    ...
    def begin(self):
        ...
        self.socket.bind((serveraddr,10080))  #serveraddr=""
        self.socket.listen(50)   #50:the maximum number of queued connections
        global connectionlist  
        i=0  
        while True: 
